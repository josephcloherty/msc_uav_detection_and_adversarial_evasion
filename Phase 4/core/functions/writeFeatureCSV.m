...
%
%   Phase 4 change: the assert now binds to phase4FeatureSchema (the
%   Phase 3 columns plus the appended CQI/MCS and traffic block). The
%   value formatting, file naming and binary-mode newline handling are
%   byte-identical to Phase 3, so a Phase 4 file with the Phase 4 columns
%   truncated is byte-identical to the corresponding Phase 3 file.
%
...
%   not substitute \r\n).
    ...
    assert(isequal(T.Properties.VariableNames, schema), ...
        ...
        'Input table columns do not match the locked Phase 4 schema.');
