...
%        rng consumption in the run. This SETUP-TIME state selects the
%        fast-fading profile (CDL-D vs CDL-C, or the Table B.1.1
...
%   bounds read BOTH ways (centre and corner conventions), because
%   cfg.aerialBounds does not record which convention produced it. Taking
%   the union is deterministic, costs only a slightly larger grid of
%   normals, and removes any chance of a UE walking off the field because
%   the convention was guessed wrongly.
