...
%  Evaluates the trained discriminant analysis on the held-out test set.
...
clc;
load('model_discriminant_analysis.mat', 'model');
...
title('Discriminant Analysis - test set confusion matrix');
